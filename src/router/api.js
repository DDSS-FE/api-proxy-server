...
const NEWS_MOCK_DATA = [
    ...
    },
    {
        ...
        image: {
            ...
            height: 453,
            contentURL:
                'https://img.hankyung.com/photo/202202/01.29067340.1.jpg',
        },
        description:
    ...
    },
    {
        ...
        image: {
            ...
            height: 482,
            contentURL:
                'https://img.hankyung.com/photo/202202/ZK.29067112.1.jpg',
        },
        description:
...
const newsFormat = (newsObj) => {
    ...
    const result = newsObj.value.map((detailNews) => {
        let { name, url, image, description, provider, datePublished } =
            detailNews;
    ...
    try {
        let options = {
            ...
            headers: {
                ...
                'x-rapidapi-key':
                    'a8e49c7bb1msh57d1dde3d79217bp1651fbjsn079f1071f121',
            },
        };
